...
<?php endif; ?>
    ...
    <header class="flex flex-col w-full max-h-[1210px] bg-[linear-gradient(0deg,_#5B8CE9_0%,_#4EB6F5_100%)] -mb-[128px]">
        <div class="flex flex-col items-center gap-6 mt-20">
            <div class="flex items-center w-fit rounded-full p-1 pr-4 gap-[10px] bg-[#DFEFFF]">
                <div class="w-12 h-12 rounded-full flex items-center justify-center shrink-0 bg-aktiv-blue overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/icons/medal-star.svg')); ?>" class="w-6 h-6" alt="icon">
                </div>
        ...
        <div class="flex w-full overflow-hidden">
            <img src="<?php echo e(asset('assets/images/backgrounds/wadedan_A_cheerful_workshop_scene_showing_a_man_presenting_his__f 1.png')); ?>"
        ...
        <div class="bg-[linear-gradient(0deg,rgba(230,231,235,0)_0%,#E6E7EB_100%)] rounded-3xl p-[1px]">
            <div class="grid grid-cols-4 items-center gap-6 rounded-3xl p-[32px_52px] bg-white">
                ...
                <div class="flex flex-col items-center rounded-2xl border border-[#E6E7EB] p-[18px] gap-3 text-center">
                    <img src="<?php echo e(asset('assets/images/icons/More Creativity.svg')); ?>" class="w-[64px]" alt="icon">
                ...
                <div class="flex flex-col items-center rounded-2xl border border-[#E6E7EB] p-[18px] gap-3 text-center">
                    <img src="<?php echo e(asset('assets/images/icons/Career Planning.svg')); ?>" class="w-[64px]" alt="icon">
                    <h3 class="font-semibold text-lg leading-[27px]">Career Planning</h3>
                    <p class="font-medium text-aktiv-grey">Lorem Ipsum itu adalah sebusah text contoh</p>
                </div>
                <div class="flex flex-col items-center rounded-2xl border border-[#E6E7EB] p-[18px] gap-3 text-center">
                    <img src="<?php echo e(asset('assets/images/icons/Good Communication.svg')); ?>" class="w-[64px]" alt="icon">
                    ...
                    <a href="<?php echo e(route('front.category', $itemCategory->slug)); ?>" class="card">
                        <div class="flex items-center h-full rounded-3xl p-5 pr-1 gap-3 bg-white">
                            ...
                            <div class="flex flex-col gap-[2px] overflow-hidden">
                                <h3 class="font-semibold text-lg leading-[27px] break-words"><?php echo e($itemCategory->name); ?></h3>
                                <p class="font-medium text-aktiv-grey"><?php echo e($itemCategory->tagline); ?></p>
                            </div>
                        </div>
                    </a>
    ...
    <section id="Trending" class="w-full max-w-[1280px] mx-auto px-[52px] mt-[100px]">
        <div class="flex flex-col gap-8">
            ...
            <div class="grid grid-cols-3 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $newWorkshops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemNewWorkshop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <?php if($itemNewWorkshop->is_open): ?>
                                        ...
                                        <?php else: ?>
                                            <div
                                                ...
                                                <img src="<?php echo e(asset('assets/images/icons/medal-star.svg')); ?>"
                                                    class="w-6 h-6" alt="icon">
                ...
                <div class="swiper w-full">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div class="flex h-full w-[436px] shrink-0 bg-aktiv-orange overflow-hidden">
                                    <img src="<?php echo e(asset('assets/images/photos/testimony1.png')); ?>"
                                ...
                                <div
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex items-center">
                                            <img src="<?php echo e(asset('assets/images/icons/Star 1.svg')); ?>"
                    ...
                    <div class="absolute w-full max-w-[1244px] mx-auto left-1/2 top-1/2 transform -translate-x-1/2 z-10">
                        <div class="swiper-button-prev !w-12 !h-12 rounded-full after:hidden">
                            <img src="<?php echo e(asset('assets/images/icons/arrow-left.svg')); ?>" class="w-full h-full"
                                alt="icon">
                        </div>
                        <div class="swiper-button-next !w-12 !h-12 rounded-full after:hidden">
                            <img src="<?php echo e(asset('assets/images/icons/arrow-left.svg')); ?>" class="w-full h-full rotate-180"
                                alt="icon">
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/In-Depth Learning from Experts Instructor.png')); ?>"
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/Tangible Results.png')); ?>"
                                class="flex w-[56px] h-[56px] shrink-0" alt="icon">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/Supportive Learning Environment.png')); ?>"
                                class="flex w-[56px] h-[56px] shrink-0" alt="icon">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/community support.png')); ?>"
                                class="flex w-[56px] h-[56px] shrink-0" alt="icon">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/Networking Opportunities With Other.png')); ?>"
                                class="flex w-[56px] h-[56px] shrink-0" alt="icon">
                    ...
                    <div
                        class="flex flex-col h-full justify-between rounded-3xl border border-[#E6E7EB] p-6 gap-3 bg-white">
                        <div class="flex items-center gap-3">
                            <img src="<?php echo e(asset('assets/images/icons/Learning Flexibility.png')); ?>"
                                class="flex w-[56px] h-[56px] shrink-0" alt="icon">
    ...
    <div id="Join-Now" class="relative w-full overflow-hidden">
        <img src="<?php echo e(asset('assets/images/backgrounds/lines.svg')); ?>" class="w-full h-full object-cover absolute"
            alt="backgrounds">
        <div
            ...
            <div class="flex w-[496px] h-full shrink-0 overflow-hidden">
                <img src="<?php echo e(asset('assets/images/photos/join-now.png')); ?>" class="w-full h-full object-contain"
                    alt="photo">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ticketing\resources\views/front/index.blade.php ENDPATH**/ ?>